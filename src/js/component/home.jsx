		...
		<div className="container mt-5" >
			...
			<div className="container mt-5 bg-black" style={{width: 200 , borderRadius: '10%'}}>
				<div className="d-inline-block d-flex flex-column align-items-center">
					...
					{
						luces.map(faro=> <button className={" d-inline-block rounded-circle m-3 " + (color == faro.valor ? faro.nombre : '' )}  style={{height: 80 , width: 80 , backgroundColor: faro.valor,}} onClick={()=>{
							setColor(faro.valor)}} />)
